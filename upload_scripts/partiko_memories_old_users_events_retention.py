...
class PartikoMemoriesOldUsersEventsRetention(object):
    """
    ...
    def compute_data(self):
        ...
        query = \
            ...
            memories as (select * from partiko.memories where key like 'experiment_%' and value in ({self.indicator_dimension}) and updated_at < '{end_time}'),
            ...
            initial_events as (select distinct id, country_code, key, value, date as initial_date, event from account inner join events_one_month on id = account_id),
