...
class VideoCtrNotificationOldUserPeopleData(object):
    """
    ...
    def compute_data(self):
        ...
        click_sql = f"""
                    ...
                    (select distinct a.account_id as account_id, memories.key as key, memories.value as value, a.country_code as country_code from 
