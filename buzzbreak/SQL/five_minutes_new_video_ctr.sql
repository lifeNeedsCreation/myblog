with
    ...
    videos as (select id, category from partiko.videos where category is not null and video_length_seconds < 60*5 and created_at > timestamp_sub(timestamp'{end_time}', interval 7 day)),
