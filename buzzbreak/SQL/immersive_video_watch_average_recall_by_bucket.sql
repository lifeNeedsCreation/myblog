with
    ...
    video_watch_count as (select country_code, placement, bucket, count(video_id) as watch_num from account_video_watch_update group by country_code, placement, bucket),
    ...
    video_impression_count as (select country_code, placement, bucket, count(account_id) as impression_user_num from account_video_impression_update group by country_code, placement, bucket),
