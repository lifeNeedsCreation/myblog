with
    ...
    video_click_group as (select country_code, placement, bucket, date, count(distinct account_id) as click_num from accounts_video_click group by country_code, placement, bucket, date),
    ...
    video_impression_group as (select country_code, placement, bucket, date, count(distinct account_id) as impression_num from accounts_video_impression group by country_code, placement, bucket, date),
    ...
    video_impression_union_group as (select country_code, placement, bucket, date, count(distinct account_id) as impression_union_num from accounts_video_impression_union group by country_code, placement, bucket, date)
