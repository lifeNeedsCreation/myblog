with
    ...
    video_click as (select account_id, placement, video_id, bucket, replace(strategy, '"', '') as strategy, date from video_click_info as v cross join unnest(v.strategies) as strategy),
