with
    ...
    video as (select id, category, video_length_seconds from partiko.videos where video_length_seconds < 60*3 and category is not null and created_at > timestamp_sub(timestamp'{end_time}', interval 7 day)),
