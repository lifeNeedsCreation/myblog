with
    ...
    videos as (select id, category from partiko.videos where category is not null and video_length_seconds < 60*1 and created_at > timestamp_sub(timestamp'{start_time}', interval 7 day)),
