with
    ...
    accounts_video_click as (select account_id, country_code, placement, video_id, experiment, strategy from video_click inner join accounts on account_id = id where experiment not like "%video_recall%"),
