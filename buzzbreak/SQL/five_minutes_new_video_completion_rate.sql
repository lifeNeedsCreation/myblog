with
    ...
    video as (select id, category, video_length_seconds from partiko.videos where video_length_seconds < 60*5 and category is not null and created_at > timestamp_sub(timestamp'{start_time}', interval 7 day)),
