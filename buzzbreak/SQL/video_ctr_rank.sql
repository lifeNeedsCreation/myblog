with
    ...
    video_click_group as (select country_code, placement, "video_multiple_recommendation_model_v4" as experiment, strategy, count(*) as click_num from accounts_video_click group by country_code, placement, strategy),
    ...
    video_impression_group as (select country_code, placement, "video_multiple_recommendation_model_v4" as experiment, strategy, count(*) as impression_num from accounts_video_impression group by country_code, placement, strategy),
    ...
    video_impression_union_group as (select country_code, placement, "video_multiple_recommendation_model_v4" as experiment, strategy, count(*) as impression_union_num from accounts_video_impression_union group by country_code, placement, strategy)
