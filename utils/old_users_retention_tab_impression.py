...
class OldUsersRetentionTabImpression(object):
    ...
    def compute_data(self):
        ...
        query = \
            ...
            initial_events as (select distinct id, country_code, created_date as initial_date, event from account inner join events_one_month on id = account_id where created_date < date),
