with
    ...
    select country_code, type, date, count(*) as posts_num from posts inner join accounts on account_id = id group by country_code, type, created_date order by country_code, type, date