...
class AllUsersVideoWatchAverage:
    # 构造函数， 初始化数据
    """
    ...
    def __init__(self, start_time, end_time, placement, table_name, logger=None):
        ...
        self.logger = logger
        self.fields = ["country_code", "placement", "date", "video_watch_num", "account_impression_num", "account_impression_union_num", "watch_avg_num", "watch_avg_num_union"]
